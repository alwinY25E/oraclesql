...
;
ALTER TABLE MATRICULA ADD CONSTRAINT MATRICULA__UN UNIQUE
(
  curso_academico
)
;
...
ALTER TABLE RESPUESTAv1 ADD CONSTRAINT RESPUESTAv2_PK PRIMARY KEY
(
  RELACION_id_relacion, EJERCICIO_id_ejercicio 
)
;

ALTER TABLE RESPUESTAv1 ADD CONSTRAINT RESPUESTAv2_EJERCICIO_FK FOREIGN KEY ( EJERCICIO_id_ejercicio ) REFERENCES EJERCICIO ( id_ejercicio ) ;

ALTER TABLE RESPUESTAv1 ADD CONSTRAINT RESPUESTAv2_RELACION_FK FOREIGN KEY ( RELACION_id_relacion ) REFERENCES RELACION ( id_relacion ) ;
