...
INSERT INTO RESPUESTA VALUES('SELECT * FROM TORTILLE;', 1.2, '54119932N', '123RFT', '14/15', 1);
INSERT INTO RESPUESTA VALUES('SELECT * FROM HUEVOS;', 2.3, '54119932N', '123RFT', '14/15', 2);
INSERT INTO RESPUESTA VALUES('SELECT * FROM SALCHICHAS;', 4.3, '54119932N', '123RFT', '14/15', 3);
INSERT INTO RESPUESTA VALUES('SELECT * FROM TORTILLE;', 1.2, '54119931B', '367GHS', '05/06', 1);
INSERT INTO RESPUESTA VALUES('SELECT * FROM HUEVOS;', 2.3, '54119931B', '367GHS', '05/06', 2);
INSERT INTO RESPUESTA VALUES('SELECT * FROM SALCHICHAS;', 4.3, '54119931B', '367GHS', '05/06', 3);

INSERT INTO RESPUESTAV1 VALUES (1, 1, 1.2, 'SELECT * FROM TORTILLE;');
INSERT INTO RESPUESTAV1 VALUES (1, 2, 2.3, 'SELECT * FROM HUEVOS;');
INSERT INTO RESPUESTAV1 VALUES (1, 3, 4.3, 'SELECT * FROM SALCHICHAS;');
INSERT INTO RESPUESTAV1 VALUES (2, 1, 1.2, 'SELECT * FROM TORTILLE;');
INSERT INTO RESPUESTAV1 VALUES (2, 2, 2.3, 'SELECT * FROM HUEVOS;');
INSERT INTO RESPUESTAV1 VALUES (2, 3, 4.3, 'SELECT * FROM SALCHICHAS;');